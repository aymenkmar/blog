...
$stmt->execute();
 ...
 while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo '<i class="fa fa-thumbs-up g-pos-rel g-top-1 g-mr-3"></i>('. $row['dislikes'] .')</li>';
    echo '<li class="list-inline-item g-mr-20">';
    echo '<a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="#!">';
    echo '<i class="fa fa-thumbs-down g-pos-rel g-top-1 g-mr-3"></i>('. $row['dislikes'] .')</li>';

    if (isset($_SESSION['login_active']) && $_SESSION['login_active'] == $row['user_id']) {
    echo '<li class="list-inline-item g-mr-20">';
